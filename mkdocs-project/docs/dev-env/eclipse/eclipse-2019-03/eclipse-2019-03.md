# TSTool / Development Environment / Eclipse 2019-03 #
...
**This documentation is an archive of old documentation that was used to set up the Eclipse IDE development environment using Eclipse 2019-03,
used for TSTool versions < 15.0.0.
The documentation should only be used as a reference but not for current development.**

The links in this documentation may become unavailable as the Eclipse web pages change.
...
The process for the 2019-03 installation is similar to previous versions.**
